...
<body class="header-fixed">
	<div class="wrapper">
		...
		<div class="breadcrumbs-v4">
			<div class="container">
				<span class="page-name">Product Filter</span>
				<h1>
				...
				<ul class="breadcrumb-v4-in">
					...
					<li class="active">Product Filter by Category</li>
				</ul>
			</div>
		</div>
							...
							<div class="row">
								...
								<div class="col-sm-8 product-description">
									...
									<div class="overflow-h margin-bottom-5">
										...
										<a href="${pageContext.request.contextPath }/product/detail?id=${p.id}" ><button type="button" class="btn-u btn-u-sea-shop">More detail</button></a>
									</div>
								</div>								
							</div>
						</div>
